...
static void
curphoo_process_auth(char *myusername, char *mypasswd, const char *seed)
{
  char *sn   = myusername;
...
char *
getstr1(char *username, char *password, const char *key) {
  curphoo_process_auth(username, password, key);
  return result6;
}

char * 
getstr2(char *username, char *password, const char *key) {
  curphoo_process_auth(username, password, key);
  return result96;
}
